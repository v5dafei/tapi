...
class CarrierPreFixDomainObserver
{
    public function created(CarrierPreFixDomain $carrierPreFixDomain)
    {
        ...
        \DB::table('conf_carrier_multiple_front')->insert($insertData);
         ...
         //创建用户分组
        $insertPlayerLevel =[
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'默认','is_system'=>1,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>1,'sort'=>0,'rechargenumber'=>0,'single_maximum_recharge'=>0,'accumulation_recharge'=>0,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'高盈利','is_system'=>1,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>0,'single_maximum_recharge'=>0,'accumulation_recharge'=>0,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'套利','is_system'=>1,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>0,'single_maximum_recharge'=>0,'accumulation_recharge'=>0,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'学前班','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>1,'single_maximum_recharge'=>100,'accumulation_recharge'=>100,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'幼儿园','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>5,'single_maximum_recharge'=>100,'accumulation_recharge'=>100,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'小学','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>10,'single_maximum_recharge'=>1000,'accumulation_recharge'=>100000,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'初中','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>10,'single_maximum_recharge'=>1000,'accumulation_recharge'=>1000000,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'高中','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>10,'single_maximum_recharge'=>1000,'accumulation_recharge'=>1500000,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'大学','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>10,'single_maximum_recharge'=>10000,'accumulation_recharge'=>25000000,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0],
            ['carrier_id' =>$carrierPreFixDomain->carrier_id,'groupname'=>'毕业','is_system'=>2,'created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s'),'is_default'=>0,'sort'=>0,'rechargenumber'=>10,'single_maximum_recharge'=>10000,'accumulation_recharge'=>50000000,'prefix'=>$carrierPreFixDomain->prefix,'game_line_id'=>0]
