...
class UpdaePlayerGradeCommand extends Command {
    ...
    public function handle()
    {
        ...
        $playerIds            = PlayerTransfer::where('type','recharge')->where('created_at','>=',date('Y-m-d H:i:s',time()-120))->pluck('player_id')->toArray();
        ...
        $tmpplayers = Player::whereIn('player_id',$playerIds)->whereNotIn('player_group_id',$noUpdateLevelIds)->pluck('player_id')->toArray();
